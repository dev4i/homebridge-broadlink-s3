...
export class LC1Switch3 {
   ...
   */
	private states = {
		pwr1: this.accessory.context.device.status.pwr1 ? this.accessory.context.device.status.pwr1 : null,
		pwr2: this.accessory.context.device.status.pwr2 ? this.accessory.context.device.status.pwr2 : null,
		pwr3: this.accessory.context.device.status.pwr3 ? this.accessory.context.device.status.pwr3 : null
	};
	...
	constructor(private readonly platform: ExampleHomebridgePlatform, private readonly accessory: PlatformAccessory) {
		...
		this.serviceSwitchOne =
			...
			this.accessory.addService(
				...
				'Switch One',
				this.accessory.context.device.did + '-1'
			);
		...
		this.serviceSwitchTwo =
			...
			this.accessory.addService(
				this.platform.Service.Switch,
				'Switch Two',
				this.accessory.context.device.did + '-2'
			);
		...
		this.serviceSwitchThree =
			...
			this.accessory.addService(
				this.platform.Service.Switch,
				'Switch Three',
				this.accessory.context.device.did + '-3'
			);
